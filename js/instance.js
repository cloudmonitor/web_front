...
function setList(i, num, data, addrs, status, UTC8_time, peizhi) {
    var str = "<tbody><tr><td><input type='checkbox'></td><td><a href='#/compute/instance_desc?" + i + "&" + num + "&" + data["OS-EXT-AZ:availability_zone"] + "'>" + data.name + "</a></td><td>" + addrs + "</td><td>" + peizhi + "</td><td>" + "-" + "</td><td>" + status + "</td>" +
        "<td>" + data["OS-EXT-AZ:availability_zone"] + "</td><td>" + "无" + "</td><td>" + "运行中" + "</td><td>" + UTC8_time +
